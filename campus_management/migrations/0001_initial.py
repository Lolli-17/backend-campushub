    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resident', models.OneToOneField(default=uuid.UUID('d92f7e17-c64d-4158-af56-b4509ebad3d4'), on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resident', models.OneToOneField(default=uuid.UUID('d92f7e17-c64d-4158-af56-b4509ebad3d4'), null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
